                   ...
                   tabItem(
                     ...
                     fluidPage(
                       ...
                       div(style = "text-align:justify", 
                           p("Dashboard ini berisi beberapa visualisasi untuk menampilkan hasil monitoring pada bulan ", tags$b("April 2024"), " pohon pada restorasi lahan disebuah daerah di Sumatera.", 
                     ...
                     fluidRow(
                       box(width = 12,
                           selectInput(
                             ...
                             label = "Pilih Species",
                             choices = unique(monitoring_clean$species_name)
                           )
                       ),
                     ),
                     fluidRow(
                       box(
                         width = 12,
                         title = "Total CO2e bedasarkan Tanggal Monitoring",
                         solidHeader = TRUE,
                         status = "primary",
                         plotlyOutput(outputId = "visual_carbon_1")
                       )
                     ),
                     div(
                       class = "footer",
